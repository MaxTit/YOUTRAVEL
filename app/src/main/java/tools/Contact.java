...
public class Contact {
    ...
    String type;
    String id;
    public  Contact(Context c, String type, String id){
        this.c = c;
        this.type = type;
        this.id = id;
    }
...
// Add the buttons
        ...
        String[] types = {"Позвонить", "Написать e-mail","Чат"};
        builder.setItems(types, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) { // +38(050) 469 4030
                ...
                switch (which) {
                    case 0:
                        intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:+380504694030"));
                        c.startActivity(Intent.createChooser(intent, "Позвонить"));
                        break;
                    case 1:
